            ...
            <table class="min-w-full bg-white">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">28 Oktober 2025</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Masuk</td>
                    ...
                    {{-- Add more transactions here later with @foreach --}}
                </tbody>
            </table>
        </div>
