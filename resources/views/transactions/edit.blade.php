                ...
                <div class="mt-4 space-y-4" id="transaction-items">
                    ...
                    <div class="flex items-center space-x-4">
                        <div class="w-1/2">
                            ...
                            <select name="items[{{ $index }}][item_id]" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                {{-- Options will be populated dynamically --}}
                        ...
                        <div class="w-1/4">
                            ...
                            <input type="number" name="items[{{ $index }}][quantity]" value="{{ $detail->quantity }}" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" placeholder="Jumlah">
                        </div>
                        <div class="w-1/4">
                            <label class="block text-sm font-medium text-gray-700">Harga</label>
                            <input type="number" name="items[{{ $index }}][price]" value="{{ $detail->price }}" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" placeholder="Harga">
                        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        let itemIndex = {{ count($transaction->details) }};
