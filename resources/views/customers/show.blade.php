...
<div class="container mx-auto">
    <div class="bg-white shadow-md rounded-lg p-6">
        <div class="flex items-center justify-between mb-6">
            ...
            <div>
                <a href="{{ route('customers.edit', $customer->id) }}" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg transition duration-300">
                    Edit
                </a>
                <a href="{{ route('customers.index') }}" class="bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-2 px-4 rounded-lg transition duration-300 ml-2">
                    Kembali ke Daftar
                </a>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                <p class="text-sm font-medium text-gray-500">Tanggal Terdaftar</p>
                <p class="text-lg text-gray-900">{{ $customer->created_at->format('d F Y H:i') }}</p>
            </div>
        </div>
